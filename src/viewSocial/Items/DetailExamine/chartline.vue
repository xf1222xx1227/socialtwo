...
export default {
  ...
  methods: {
    getMonthData() {
      ...
      this.str = "";
      this.attribute = "";
      this.attribute += ",substring(c.examinetime,1,7) as 'date' ";
      this.groupby = "";
      this.groupby += `,substring(c.examinetime,1,7)`;
      this.str +=
        ` and substring(c.examinetime,6,2) between '` +
        begin +
        `' and '` +
        end +
        `' and substring(c.examinetime,1,4)='` +
        year +
        `' `;
      this.getData();
    },
    getYearData() {
      ...
      this.str = "";
      this.attribute = "";
      this.attribute += " ,substring(c.examinetime,1,4) as 'date' ";
      this.groupby = "";
      this.groupby += `,substring(c.examinetime,1,4)`;
      this.str +=
        ` and substring(c.examinetime,1,4) between '` +
        begin +
        `' and '` +
        end +
        `' `;
    ...
    getDayData() {
      ...
      this.str = "";
      this.attribute = "";
      this.attribute += ",substring(c.examinetime,1,10) as 'date' ";
      this.groupby = "";
      this.groupby += `,substring(c.examinetime,1,10)`;
      this.str +=
        ` and substring(c.examinetime,9,2) between '` +
        begin +
        `' and '` +
        end +
        `' and substring(c.examinetime,1,7)='` +
        year +
        `' `;
      this.getData();
    },
    ...
    getData() {
      this.dataChart = [];
      this.$api
        .getOneBiddingUsersDetailCategoryItems({
