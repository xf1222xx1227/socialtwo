  ...
  <div class="totalCalibration" v-show="visible">
    ...
    <div class="bottom">
      <div class="left">
        ...
        <FinishFirstAndDetail
          ref="dialogfinishfirst"
          :datadetail="datafinish"
          @getState="getfinishdata"
...
<script>
import FinishFirstAndDetail from "./finishFirst.vue";
import Details from "../../ExamineInvitation/itemDetails.vue";
import Ranking from "./ranking.vue";
import ExamineTable from "./centerTable.vue";
import myFunctions from "@/myFunctions";
export default {
  components: { FinishFirstAndDetail, Details, Ranking, ExamineTable },
  data() {
    return {
      visible: false,
