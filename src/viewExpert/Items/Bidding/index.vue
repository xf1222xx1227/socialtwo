    ...
    >
      ...
      <el-table-column label="操作" align="center" width="220" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button
            @click.native.prevent="biddingEdit(scope.$index, dataTable)"
            type="text"
            size="small"
          >
            <!-- <i class="el-icon-edit"></i> -->
...
import BidDetail from "./detailBid"; // 申报详情
import Detail from "../../../views/Items/Bidding/add.vue"; // 发布详情
export default {
